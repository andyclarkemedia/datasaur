		...
		let result = (
			...
			<div>
				<header id="top-header-container" className="fixed-top">
				    ...
				    <p id="sub_head">The green entrepreneurs<br/>fighting for ethical share<br/>of the market</p>
				...
				<main className="margin-body">
					...
					<section className="thin flex-container-column text-centralise">
						...
						<p className="opening-paragraph paragraph-margin">
							...
							Leading scientists <a href="https://www.theguardian.com/world/2020/mar/25/coronavirus-nature-is-sending-us-a-message-says-un-environment-chief">are saying</a> that the covid-19 outbreak presents a “clear warning shot” of more deadly diseases to come if we do not stop destroying the natural world. However, pioneers of the “green” economy, businesses who care about more than just a bottom line, are in a “constant battle” to survive despite being considered as part of the solution to climate change
						...
						<p className="text paragraph-margin">
							...
							Set in the heart of Carmarthen in Wales, <a href="https://www.warrenmanselst.co.uk/">The Warren</a> is a unique restaurant not only in its labyrinthine-like décor that sparks curiosity the moment you walk in but also in the way it was founded. The owner Deri Reed, a self-proclaimed “ethical chef”, opened The Warren to nurture relationships with other local businesses and to run a restaurant according to his vision of environmental sustainability. Every item on The Warren’s menu has been sourced from local farms that Deri Reed visits personally to ensure that they practice organic farming and follow the right animal welfare practices.
				    ...
				    <div className="left_chart">
				      <div className="struggle">
								<p className="pictogram_number">70%</p>
				        <p className="pictogram_text">small business</p><p className="pictogram_text">struggle to embrace ethical practices</p>
				        <table className="tg">
				          <tr>
				        ...
				        <p className="pictogram_text">... while</p>
								<p className="pictogram_number">30%</p>
								<p className="pictogram_text">have no barriers</p>
				      </div>
				    </div>
				    <div className="right_chart">
				      <div className="costly">
				        <p className="pictogram_number">41%</p>
								<p className="pictogram_text">Too costly to implement</p>
				        <table className="tg">
				          <tr>
				            <td className="tg-red"></td>
				            <td className="tg-red"></td>
				          ...
				          <tr>
				            ...
				            <td className="tg-red"></td>
				            <td className="tg-red"></td>
				            <td className="tg-white"></td>
				          </tr>
				        </table>
				      </div>
				      <div className="assesment">
				        <p className="pictogram_number">17%</p><p className="pictogram_text">No metrics</p>
								<p className="pictogram_text">to assess impact</p>
				        <table className="tg">
				          <tr>
				            <td className="tg-white"></td>
				            <td className="tg-red"></td>
				      ...
				      <div className="research">
				        <p className="pictogram_number">16%</p>
								<p className="pictogram_text">Too time-consuming</p>
								<p className="pictogram_text">to research</p>
				        <table className="tg">
				          <tr>
				            <td className="tg-red"></td>
				            <td className="tg-red"></td>
				      ...
				      <div className="roi">
				        <p className="pictogram_number">15%</p>
								<p className = "pictogram_text">No immediate</p>
								<p className="pictogram_text">ROI</p>
				        <table className="tg">
				          <tr>
				            <td className="tg-red"></td>
				            <td className="tg-red"></td>
				      ...
				      <div className="management">
				        <p className="pictogram_number">15%</p>
								<p className="pictogram_text">No buy-in from</p>
								<p className="pictogram_text">senior managements</p>
				        <table className="tg">
				          <tr>
				            <td className="tg-red"></td>
				            <td className="tg-red"></td>
				      ...
				      <div className="customers">
				        <p className="pictogram_number">15%</p>
								<p className="pictogram_text">I don't believe</p>
								<p className="pictogram_text">customers are interested</p>
				        <table className="tg">
				          <tr>
				            <td className="tg-red"></td>
				            <td className="tg-red"></td>
						...
						<p>Source: <a href="https://www.creativebrief.com/user_files/24990/1520430598_18FeetRising_TheUprising_Report.pdf">The Uprising report</a></p>
				  </div>
					...
					<section className="thin flex-container-column text-centralise">
						...
						<p className="text paragraph-margin">According to data of more than 350 UK companies certificated by <a href="https://bcorporation.net/">Bcorps</a>, a trusted international certification body for ethical businesses, one-third comes from consultancy, food industry and more than 90% are small and medium enterprises. However, it is just a glimpse of a big picture. There could be much more environmentally-sustainable businesses in a wider range of industries that does not get any recognition.</p>

						<p className="text paragraph-margin">

							Even though being an environmentally-sustainable entrepreneur means something different to each individual,<a href="https://www-sciencedirect-com.abc.cardiff.ac.uk/science/article/pii/S0959652617300720">one recent study</a> suggests that the ultimate goal for these business owners is not great wealth but rather to “spread their green values, educate society and to follow their passions for a green business idea”. The issue for businesses is often “in terms of the supply chain” says Alex Fitoni, an environmental specialist with the Mabbett consultancy firm, ‘How do you make sure the products you use are sustainable?’.  Suppliers and their processes have to be traceable so that a business can be sure all their ingredients and materials are grown and processed according to their own ethical standards.
					...
					<section id="slide_init">
						...
						<div className="mySlides fade">
							...
							<div className="caption_text">
							<p className = 'first_quote'>“I wished I could have done it (using organic cotton) two years, three years ago but I am not there yet” </p>
							<p className='character'>Griffiths says</p>
							<p className = 'analysis'>Maykher is still using regular cotton instead of organic one.  Since working with a handful of artisan groups which are only able to make products in a limited quantity, Maykher cannot order organic cotton in bulk to make it affordable.</p>
							</div>
						</div>
						...
						<div className="mySlides fade">
							...
							<div className="caption_text">
								...
								<p className = "analysis">“We can’t function without potatoes” – Reed said. In the past, he used to resort to other sources when his local farm runs out of potatoes. At the moment, with more storage, he can bulk buy to make sure this never happened with potatoes but not about every other vegetable. The fact that he runs out of ingredients and have to face the dilemma whether to change the whole menu or buy substitute from other sellers still happens once in one or two months. He says, “it does happen, I cannot lie about that’</p>
							</div>
						</div>
						...
						<div className="mySlides fade">
							...
							<div className="caption_text">
								<p className = "first_quote">“The thing I would really want to do, like in the perfect world, which is to have all the yarn that I use to be vegetarian”</p>
								<p className="character">Suzanna James, founder of Suzanna James Knitwear</p>
								<p className = "analysis">All of Suzanna’s yarn is slaughter-free except for the alpaca one from Peru since alpaca “is fundamental” to the Peruvian’s food chain, as she says. However, she still want to work with her female artisan group there because she want to make contribution to women empowerment and craftsmanship preservation in this country. </p>
					...
					<section className="thin flex-container-column text-centralise">
						...
						<p className="text paragraph-margin">
							...
							Green entrepreneurs hesitate to call themselves sustainable, with some dismissing the term altogether. “I want to have a business that doesn’t cause harm to myself, to others or to the environment. ‘Sustainability’, ‘eco’, ‘climate’, I would disregard myself from those terms”, says Stuart Collins, founder of <a href="https://uplandsroast.com/">Uplands Roast</a> an Edinburgh-based coffee business that works directly with local farmers in developing countries. The term “sustainability” is sometimes abused by organizations taking advantage of the environment as a hot topic to increase their customer base. For committed green entrepreneurs sustainability is a journey rather than a destination.
